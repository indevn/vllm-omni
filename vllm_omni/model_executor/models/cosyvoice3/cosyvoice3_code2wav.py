...
class CosyVoice3Code2Wav(nn.Module):
    ...
    def _forward_mel(
        ...
        with null_or_range("cosyvoice3_code2wav:flow_inference"):
    ...
    def forward_streaming(
        ...
        *,
        ...
        """
        with null_or_range("cosyvoice3_code2wav:forward_streaming"):
        ...
        if isinstance(cached_mel, torch.Tensor) and cached_mel.numel() > 0:
            ...
            tts_mel = (
                torch.cat([cached_mel, chunk_mel], dim=-1)
        ...
        if tts_mel.shape[-1] == 0:
            ...
            with null_or_range("cosyvoice3_code2wav:hift_inference"):
