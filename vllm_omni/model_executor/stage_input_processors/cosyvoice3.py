...
from vllm_omni.profiling.markers import null_or_range
...
def talker2code2wav_async_chunk(
    ...
    with null_or_range("cosyvoice3:talker2code2wav_async_chunk"):
        ...
        if not isinstance(request_state, dict) or "_cosyvoice3_async_state" not in request_state:
            with null_or_range("cosyvoice3:decode_prompt_payload"):
        ...
        with null_or_range("cosyvoice3:delta_tokens"):
        ...
        with null_or_range("cosyvoice3:chunk_gate"):
        ...
        with null_or_range("cosyvoice3:build_codes_window"):
